...
/******/ 	var installedChunks = {
/******/ 		"blocks-fpbk-pardot-form-pardot-form": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push([234,"common-helpers","common-modules","vendor-core-js","vendor-dashify","vendor-magnum-ui","vendor-smoothscroll-polyfill","vendor-js-cookie","common-json","vendor-uuid","vendor-bootstrap","vendor-crypto-js"]);
...
/***/ "../blocks/fpbk/pardot-form/src/frontend/pardot-form.js":
/*!**************************************************************!*\
  !*** ../blocks/fpbk/pardot-form/src/frontend/pardot-form.js ***!
  \**************************************************************/
/*! no exports provided */
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var scripts_modules_tracking__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! scripts/modules/_tracking */ "./scripts/modules/_tracking.js");
...
const initPardotForm = pardotForm => {
  ...
  let email; // eslint-disable-next-line @wordpress/no-global-event-listener
  ...
  window.addEventListener('message', e => {
    ...
    if (e && e.data) {
      ...
      if (e.data.frameHeight && isSameSource) {
        iframe.style.height = "".concat(e.data.frameHeight, "px");
      } // Form start tracking.
      ...
      if (e.data.email) {
        email = crypto_js_sha256__WEBPACK_IMPORTED_MODULE_2___default()(e.data.email).toString();
      ...
      if (e.data.formSubmitted && isSameSource) {
        ...
        const $thankYouModal = $(".pardot-modal#".concat(thankYouModalId)); // Hide modal with form

        if ($('.modal_with-form').length && !persistentPopup && $('.modal_with-form').attr('data-pardot-thank-you') !== '1') {
          ...
          $('.modal_with-form [data-dismiss="modal"]').trigger({
            type: 'click'
          });
...
Object(scripts_helpers_blocks__WEBPACK_IMPORTED_MODULE_1__["initBlock"])('.pardot-form', initPardotForm);
...
/***/ 234:
/*!********************************************************************!*\
  !*** multi ../blocks/fpbk/pardot-form/src/frontend/pardot-form.js ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/xue.ding/freshpress-website/themes/freshpress/blocks/fpbk/pardot-form/src/frontend/pardot-form.js */"../blocks/fpbk/pardot-form/src/frontend/pardot-form.js");
...
/******/ });
//# sourceMappingURL=blocks-fpbk-pardot-form-pardot-form.js.map