...
/******/ 	var installedChunks = {
/******/ 		"templates-common-signup-page-form": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push([40,"common-helpers","common-modules","vendor-core-js","vendor-dashify","vendor-magnum-ui","vendor-smoothscroll-polyfill","vendor-js-cookie","common-json","vendor-uuid","vendor-bootstrap","vendor-validator","vendor-is-plain-obj"]);
...
/***/ "./scripts/templates/common/signup-page-form.js":
/*!******************************************************!*\
  !*** ./scripts/templates/common/signup-page-form.js ***!
  \******************************************************/
/*! no exports provided */
...
/* harmony import */ var scripts_modules_signup__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! scripts/modules/_signup */ "./scripts/modules/_signup.js");
...
const initializeSignup = () => {
  ...
  Object(scripts_modules_signup__WEBPACK_IMPORTED_MODULE_0__["handleSsoSignup"])('google');
  Object(scripts_modules_signup__WEBPACK_IMPORTED_MODULE_0__["handleSsoSignup"])('apple');
  const promoEnd = parseInt(Object(scripts_helpers_attributes__WEBPACK_IMPORTED_MODULE_2__["getDataAttr"])(signup, 'promo-end'), 10);
  const now = Math.floor(Date.now() / 1000);

  if (!Object(scripts_helpers_utils__WEBPACK_IMPORTED_MODULE_1__["isNfbCustomer"])() && promoEnd && now < promoEnd) {
    if ('false' === Object(scripts_helpers_attributes__WEBPACK_IMPORTED_MODULE_2__["getDataAttr"])(signup, 'promo')) {
      Object(scripts_helpers_attributes__WEBPACK_IMPORTED_MODULE_2__["setDataAttr"])(signup, 'promo', 'true');
    }
  }

  const signupForm = signup.querySelector('form.sign-up__form');
  const tosPrivacyCheckbox = signup.querySelector('#tos-accepted');
  const tosPrivacyLabel = signup.querySelector('.sign-up__policy-privacy');
...
document.addEventListener('DOMContentLoaded', initializeSignup, false);

/***/ }),

/***/ "./styles/templates/common/signup-page-form.scss":
/*!*******************************************************!*\
  !*** ./styles/templates/common/signup-page-form.scss ***!
  \*******************************************************/
/*! no static exports found */
...
/***/ 40:
/*!************************************************************************************************************!*\
  !*** multi ./scripts/templates/common/signup-page-form.js ./styles/templates/common/signup-page-form.scss ***!
  \************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /Users/xue.ding/freshpress-website/themes/freshpress/assets/scripts/templates/common/signup-page-form.js */"./scripts/templates/common/signup-page-form.js");
module.exports = __webpack_require__(/*! /Users/xue.ding/freshpress-website/themes/freshpress/assets/styles/templates/common/signup-page-form.scss */"./styles/templates/common/signup-page-form.scss");
...
/******/ });
//# sourceMappingURL=templates-common-signup-page-form.js.map