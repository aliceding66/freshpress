...
/******/ 	deferredModules.push([41,"common-helpers","common-modules","vendor-core-js","vendor-dashify","vendor-magnum-ui","vendor-smoothscroll-polyfill","vendor-js-cookie","common-json"]);
...
/* harmony import */ var scripts_modules_i18n__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! scripts/modules/_i18n */ "./scripts/modules/_i18n.js");
...
const init404PageScripts = () => {
  const renderAutomaticResults = data => {
    ...
    data.records.page.forEach(result => {
      ul.insertAdjacentHTML('beforeend', "<li><a href=\"".concat(result.url, "\">").concat(result.highlight && result.highlight.title || result.title, "</a>"));
    });
  };

  const siteRegionCode = "".concat(Object(scripts_modules_i18n__WEBPACK_IMPORTED_MODULE_1__["getLanguage"])(), "-").concat(Object(scripts_modules_i18n__WEBPACK_IMPORTED_MODULE_1__["getSiteCountryCode"])()).toLowerCase();
  $.ajax({
    dataType: 'json',
...
/***/ "./styles/templates/page/404.scss":
/*!****************************************!*\
  !*** ./styles/templates/page/404.scss ***!
  \****************************************/
/*! no static exports found */
...
/***/ 41:
/*!******************************************************************************!*\
  !*** multi ./scripts/templates/page/404.js ./styles/templates/page/404.scss ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /Users/xue.ding/freshpress-website/themes/freshpress/assets/scripts/templates/page/404.js */"./scripts/templates/page/404.js");
module.exports = __webpack_require__(/*! /Users/xue.ding/freshpress-website/themes/freshpress/assets/styles/templates/page/404.scss */"./styles/templates/page/404.scss");
...
/******/ });
//# sourceMappingURL=templates-page-404.js.map