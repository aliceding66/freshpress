...
/******/ 	var installedChunks = {
/******/ 		"blocks-fpbk-product-tour-product-tour-block": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push([236,"common-helpers","common-modules","vendor-swiper","vendor-lite-youtube-embed"]);
...
/***/ "../blocks/fpbk/product-tour/src/frontend/product-tour-block.js":
/*!**********************************************************************!*\
  !*** ../blocks/fpbk/product-tour/src/frontend/product-tour-block.js ***!
  \**********************************************************************/
/*! no exports provided */
...
/* harmony import */ var scripts_helpers_lite_youtube__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! scripts/helpers/_lite_youtube */ "./scripts/helpers/_lite_youtube.js");
/**
 * Product Tour.
 */
...
const handleSwiper = productTour => {
  ...
  const checkOnResize = () => {
    if (window.screen.width >= 1024 && productTour.swiper && productTour.swiperVisible === true) {
      productTour.swiperVisible = false;
  ...
  items.forEach((item, itemIndex) => {
    ...
    if (videoNode) {
      ...
      playButton.addEventListener('click', () => {
        Object(scripts_helpers_lite_youtube__WEBPACK_IMPORTED_MODULE_3__["playVideo"])(videoNode);
      ...
      closeButton.addEventListener('click', () => {
        ...
        Object(scripts_helpers_lite_youtube__WEBPACK_IMPORTED_MODULE_3__["pauseVideo"])(videoNode);
      });
    }
  });
};
  ...
  const recalculateArrowsPosition = () => {
    ...
    if (activeItem) {
      ...
      arrows.forEach(arrow => {
        arrow.style.top = "".concat(halfOfActiveItemHeight, "px");
      });
    }
  };
...
Object(scripts_helpers_blocks__WEBPACK_IMPORTED_MODULE_0__["initBlock"])('.product-tour', initProductTour);

/***/ }),

/***/ 236:
/*!****************************************************************************!*\
  !*** multi ../blocks/fpbk/product-tour/src/frontend/product-tour-block.js ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/xue.ding/freshpress-website/themes/freshpress/blocks/fpbk/product-tour/src/frontend/product-tour-block.js */"../blocks/fpbk/product-tour/src/frontend/product-tour-block.js");


/***/ })

/******/ });
//# sourceMappingURL=blocks-fpbk-product-tour-product-tour-block.js.map