...
/***/ "../blocks/acf/lottie-animation/lottie-animation.js":
/*!**********************************************************!*\
  !*** ../blocks/acf/lottie-animation/lottie-animation.js ***!
  \**********************************************************/
/*! no exports provided */
...
const fetchFieldValue = (lottieAnimationNode, inputName, callback = null) => {
  const field = lottieAnimationNode.querySelector("[data-name=\"".concat(inputName, "\"]"));
...
const resizeUsingAnimationData = (lottieAnimationNode, animationData) => {
  if (animationData) {
    if (animationData.w) {
      lottieAnimationNode.style.width = "".concat(animationData.w, "px}");
    }

    if (animationData.h) {
      lottieAnimationNode.style.height = "".concat(animationData.h, "px}");
    }
  }
};
...
const initLottieAnimation = lottieAnimationNode => {
  ...
  if (path) {
    config.path = path; // eslint-disable-next-line no-undef

    fetch(path).then(res => res.json()).then(animationData => {
      if (animationData) {
        resizeUsingAnimationData(lottieAnimationNode, animationData);
      }
    }).catch(() => {
      // Set default values.
      resizeUsingAnimationData(lottieAnimationNode, {
        w: 500,
        h: 500
      });
    });
  ...
  const animation = lottie_web__WEBPACK_IMPORTED_MODULE_0___default.a.loadAnimation(config);
...
Object(scripts_helpers_blocks__WEBPACK_IMPORTED_MODULE_1__["initBlock"])('.lottie-animation', initLottieAnimation);

/***/ }),

/***/ 13:
/*!****************************************************************!*\
  !*** multi ../blocks/acf/lottie-animation/lottie-animation.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/xue.ding/freshpress-website/themes/freshpress/blocks/acf/lottie-animation/lottie-animation.js */"../blocks/acf/lottie-animation/lottie-animation.js");


/***/ })

/******/ });
//# sourceMappingURL=blocks-acf-lottie-animation-lottie-animation.js.map