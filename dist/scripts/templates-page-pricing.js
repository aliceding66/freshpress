...
/******/ 	deferredModules.push([48,"common-helpers","common-modules","vendor-core-js","vendor-dashify","vendor-magnum-ui","vendor-smoothscroll-polyfill","vendor-js-cookie","common-json","vendor-swiper"]);
...
/***/ "./scripts/templates/page/pricing.js":
/*!*******************************************!*\
  !*** ./scripts/templates/page/pricing.js ***!
  \*******************************************/
/*! no exports provided */
...
/* harmony import */ var scripts_modules_cookies__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! scripts/modules/_cookies */ "./scripts/modules/_cookies.js");
...
const handleTermSwitch = pricingTable => {
  ...
  if (termSwitch) {
    termSwitch.addEventListener('change', e => {
      ...
      Object(scripts_helpers_attributes__WEBPACK_IMPORTED_MODULE_3__["setDataAttr"])(pricingTable, 'term', newTerm);
      Object(scripts_helpers_attributes__WEBPACK_IMPORTED_MODULE_3__["setDataAttr"])(comparisonTable, 'term', newTerm);
    });
  }
};
...
const handleTestimonialSwiper = () => {
  ...
  swiperContainers.forEach(swiperContainer => {
    ...
    const enableSwiper = () => {
      swiperContainer.swiper = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](swiperContainer, swiperConfig);
...
const handleSwiper = pricingTable => {
  ...
  const initSwiper = () => {
    ...
    if (pricingTable.swiperVisible === false) {
      pricingTable.swiper = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](swiperContainer, swiperConfig);
  ...
  const checkOnResize = () => {
    if (window.screen.width >= 768 && pricingTable.swiper && pricingTable.swiperVisible === true) {
      pricingTable.swiperVisible = false;
...
const comparisonTableStickyHeader = () => {
  ...
  const isCustomer = Object(scripts_modules_cookies__WEBPACK_IMPORTED_MODULE_4__["readCookie"])('smux_login');
...
const selectPlans = plansToShow => {
  ...
  const mobileSwitches = comparisonTable.querySelectorAll('.comparison-table__mobile-header-sticky ul li'); // const mobileSelect = pricingTable.querySelector( '#select-plans' );

  const recommendedPlan = plansToShow.split(',')[0];
  const recommendedMobileSwitch = comparisonTable.querySelector(".comparison-table__mobile-header-sticky ul li[data-plan=\"".concat(recommendedPlan, "\"]"));
  ...
  if (pricingTable.swiper) {
    const recommendedSlideIndex = Array.from(allPlansEls).indexOf(pricingTable.querySelector(".pricing-table_column[data-plan=\"".concat(recommendedPlan, "\"]")));
...
const comparisonTableToggles = () => {
  const comparisonTable = document.querySelector('.comparison-table');
  const mobileSwitches = comparisonTable.querySelectorAll('.comparison-table__mobile-header-sticky ul li');
    ...
    toggles.forEach(toggle => {
      toggle.addEventListener('click', e => {
        ...
        if (visiblePlans.includes('lite')) {
          visiblePlans = [...visiblePlans.filter(item => item !== 'lite'), 'lite'];
        }
...
const pricingPageToggles = pricingTable => {
  ...
  if (toggleButtons) {
    toggleButtons.forEach(toggleButton => {
      toggleButton.addEventListener('click', () => {
        ...
        window.history.pushState('', '', "".concat(window.location.pathname).concat('show-all-plans' === planName ? '' : "?for=".concat(planName)));
  ...
  if (mobileSelect) {
    mobileSelect.addEventListener('change', () => {
      const planName = Object.keys(plansSet).find(key => plansSet[key] === mobileSelect.value);
      window.history.pushState('', '', "".concat(window.location.pathname).concat(undefined === planName ? '' : "?for=".concat(planName)));
...
const setInitialPlans = pricingTable => {
  ...
  if (planName !== null && possiblePlans.includes(planName)) {
    const activeButton = pricingTable.querySelector(".pricing-table__desktop-categories li[data-plans-for=\"".concat(plansSet[planName], "\"]"));
...
const pricingColumnsToggles = pricingTable => {
  ...
  const expandFeaturesToggles = pricingTable.querySelectorAll('.pricing-table_column-mobile-features__details');
...
const stickyHeaderTitle = () => {
  const getClosestTitle = (titlesArr, targetOffset) => titlesArr.reduce((acc, obj) => Math.abs(targetOffset - obj.offsetTop) < Math.abs(targetOffset - acc.offsetTop) ? obj : acc);

  const titleContainer = document.querySelector('.comparison-table__header-sticky-title');
  const titleEls = document.querySelectorAll('.comparison-table__category-plan > tr > th:first-child');
  const titles = [];
...
/***/ "./styles/templates/page/pricing.scss":
/*!********************************************!*\
  !*** ./styles/templates/page/pricing.scss ***!
  \********************************************/
/*! no static exports found */
...
/***/ 48:
/*!**************************************************************************************!*\
  !*** multi ./scripts/templates/page/pricing.js ./styles/templates/page/pricing.scss ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /Users/xue.ding/freshpress-website/themes/freshpress/assets/scripts/templates/page/pricing.js */"./scripts/templates/page/pricing.js");
module.exports = __webpack_require__(/*! /Users/xue.ding/freshpress-website/themes/freshpress/assets/styles/templates/page/pricing.scss */"./styles/templates/page/pricing.scss");
...
/******/ });
//# sourceMappingURL=templates-page-pricing.js.map