...
/******/ 	deferredModules.push([44,"common-helpers","common-modules","vendor-core-js","vendor-dashify","vendor-magnum-ui","vendor-smoothscroll-polyfill","vendor-js-cookie","common-json","vendor-uuid","vendor-bootstrap","vendor-swiper","vendor-validator","vendor-is-plain-obj","vendor-lite-youtube-embed"]);
...
/*!************************************************************************!*\
  !*** /Users/xue.ding/freshpress-website/node_modules/dom7/dom7.esm.js ***!
  \************************************************************************/
...
/*!************************************************************************************!*\
  !*** /Users/xue.ding/freshpress-website/node_modules/ssr-window/ssr-window.esm.js ***!
  \************************************************************************************/
...
/***/ "./scripts/templates/page/homepage.js":
/*!********************************************!*\
  !*** ./scripts/templates/page/homepage.js ***!
  \********************************************/
/*! no exports provided */
...
/* harmony import */ var lite_youtube_embed__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lite-youtube-embed */ "../../../node_modules/lite-youtube-embed/src/lite-yt-embed.js");
/* harmony import */ var lite_youtube_embed__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(lite_youtube_embed__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var scripts_helpers_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! scripts/helpers/_utils */ "./scripts/helpers/_utils.js");
...
/* harmony import */ var scripts_helpers_lite_youtube__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! scripts/helpers/_lite_youtube */ "./scripts/helpers/_lite_youtube.js");
...
const initPromoHero = () => {
  ...
  if (!Object(scripts_helpers_utils__WEBPACK_IMPORTED_MODULE_4__["isNfbCustomer"])()) {
    const pricingTable = document.querySelector('.pricing-table');

    if ('true' === Object(scripts_helpers_attributes__WEBPACK_IMPORTED_MODULE_5__["getDataAttr"])(pricingTable, 'promo-exists') && 'true' === Object(scripts_helpers_attributes__WEBPACK_IMPORTED_MODULE_5__["getDataAttr"])(pricingTable, 'promo-show') || promoHero.dataset.isActiveCampaign) {
...
const hero = () => {
  const inputs = document.querySelectorAll('.hero__signup-form-email *, .hero__signup-form-btn *, .expandable:not(.sso) *');
  const expandableItems = document.querySelectorAll('.expandable');
  const formExitButton = document.querySelector('#close-form');
  Object(scripts_modules_signup__WEBPACK_IMPORTED_MODULE_3__["handleSsoSignup"])('google');
  Object(scripts_modules_signup__WEBPACK_IMPORTED_MODULE_3__["handleSsoSignup"])('apple');
...
const handleProductTour = () => {
  ...
  const handleNav = productTour => {
    ...
    const showItem = index => {
      const videosExitButtons = document.querySelectorAll('.product-tour__item-close-video');
      ...
      const ItemsCollection = productTour.querySelectorAll(productTourClasses.item); // Resets all classes and reveals the one clicked.
      ...
      ItemsCollection.item(index).classList.add(productTourClasses.itemActiveClass); // Treats the display of the arrows.

      if (index === 0) {
        productTour.querySelector(productTourClasses.arrowNavLinkPrevious).classList.remove(productTourClasses.arrowNavLinkActiveClass);
      } else {
        productTour.querySelector(productTourClasses.arrowNavLinkPrevious).classList.add(productTourClasses.arrowNavLinkActiveClass);
      }

      if (index === itemsLength - 1) {
        productTour.querySelector(productTourClasses.arrowNavLinkNext).classList.remove(productTourClasses.arrowNavLinkActiveClass);
      } else {
        productTour.querySelector(productTourClasses.arrowNavLinkNext).classList.add(productTourClasses.arrowNavLinkActiveClass);
      }
    }; // Arrow nav.
    ...
    const videoToggle = () => {
      ...
      items.forEach((item, itemIndex) => {
        const videoNode = item.querySelector("#video".concat(itemIndex));
        ...
        if (videoNode) {
          ...
          playButton.addEventListener('click', () => {
            Object(scripts_helpers_lite_youtube__WEBPACK_IMPORTED_MODULE_6__["playVideo"])(videoNode);
          ...
          closeButton.addEventListener('click', () => {
            ...
            Object(scripts_helpers_lite_youtube__WEBPACK_IMPORTED_MODULE_6__["pauseVideo"])(videoNode);
          });
        }
      });
    };
  ...
  const handleSwiper = productTour => {
    ...
    const enableSwiper = () => {
      productTour.swiper = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](swiperContainer, swiperConfig);
...
const handleSwiper = () => {
  ...
  swiperContainers.forEach(swiperContainer => {
    ...
    const hasPagination = document.querySelector(".".concat(blockClass, " ~ .swiper-pagination")) ? {
      el: document.querySelector(".".concat(blockClass, " ~ .swiper-pagination")),
      type: 'bullets',
      clickable: true
    } : false;
    let swiperEnabled = false;
    const hasNavigation = document.querySelector(".".concat(blockClass, " ~ .swiper-button-next")) && document.querySelector(".".concat(blockClass, " ~ .swiper-button-prev")) ? {
      nextEl: document.querySelector(".".concat(blockClass, " ~ .swiper-button-next")),
      prevEl: document.querySelector(".".concat(blockClass, " ~ .swiper-button-prev"))
    } : false;
    const swiperConfig = {
      init: false,
      loop: false,
    ...
    const enableSwiper = () => {
      swiperContainer.swiper = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](swiperContainer, swiperConfig);
...
/***/ "./styles/templates/page/homepage.scss":
/*!*********************************************!*\
  !*** ./styles/templates/page/homepage.scss ***!
  \*********************************************/
/*! no static exports found */
...
/***/ 44:
/*!****************************************************************************************!*\
  !*** multi ./scripts/templates/page/homepage.js ./styles/templates/page/homepage.scss ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /Users/xue.ding/freshpress-website/themes/freshpress/assets/scripts/templates/page/homepage.js */"./scripts/templates/page/homepage.js");
module.exports = __webpack_require__(/*! /Users/xue.ding/freshpress-website/themes/freshpress/assets/styles/templates/page/homepage.scss */"./styles/templates/page/homepage.scss");
...
/******/ });
//# sourceMappingURL=templates-page-homepage.js.map