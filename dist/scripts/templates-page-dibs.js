...
/******/ 	deferredModules.push([43,"common-modules","vendor-swiper"]);
...
/***/ "./scripts/templates/page/dibs.js":
/*!****************************************!*\
  !*** ./scripts/templates/page/dibs.js ***!
  \****************************************/
/*! no exports provided */
...
document.addEventListener('DOMContentLoaded', function () {
  const initJourneyDesktop = () => {
    ...
    timelineEls.forEach(el => {
      ...
      el.addEventListener('mouseover', () => {
        ...
        document.querySelector('#journey_desktop__tooltip-year').textContent = el.dataset.year;
        document.querySelector('#journey_desktop__tooltip-text').textContent = el.dataset.text;
  ...
  const initGraph = () => {
    ...
    graphEls.forEach(el => {
      ...
      el.style.height = percentage; // creates the tooltips
      ...
      tooltipPercentage.textContent = percentage; // appends the tooltips
  ...
  const initChampionsSwiper = () => {
    ...
    const championsSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](championsSwiperContainer, championsSwiperConfig);
  ...
  const initGraphSwiper = () => {
    ...
    const graphSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](graphSwiperContainer, graphSwiperConfig);
    graphSwiper.init();
  };
  ...
  const initJourneySwiper = () => {
    const journeySwiperContainer = document.querySelector('.journey_mobile__slides-container');
    ...
    const journeySwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](journeySwiperContainer, journeySwiperConfig);
    journeySwiper.init();
  };
...
/***/ "./styles/templates/page/dibs.scss":
/*!*****************************************!*\
  !*** ./styles/templates/page/dibs.scss ***!
  \*****************************************/
...
/***/ 43:
/*!********************************************************************************!*\
  !*** multi ./scripts/templates/page/dibs.js ./styles/templates/page/dibs.scss ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /Users/xue.ding/freshpress-website/themes/freshpress/assets/scripts/templates/page/dibs.js */"./scripts/templates/page/dibs.js");
module.exports = __webpack_require__(/*! /Users/xue.ding/freshpress-website/themes/freshpress/assets/styles/templates/page/dibs.scss */"./styles/templates/page/dibs.scss");


/***/ })

/******/ });
//# sourceMappingURL=templates-page-dibs.js.map