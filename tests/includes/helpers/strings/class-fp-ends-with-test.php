<?php
/**
 * Tests function fp_ends_with() helper functions.
 *
...
/**
 *  FP_Ends_With_Test class.
 */
class FP_Ends_With_Test extends FP_Base_Test {

	/**
	 * Checks whether function fp_ends_with() return expected value.
	 *
	...
	public function testIfReturnsExpectedValue( $haystack, $needle, $expected ) {
		$this->assertEquals( $expected, fp_ends_with( $haystack, $needle ) );
	}
	...
	public function returnsExpectedValueDataProvider() {
		return [
			'no data passed'                       => [
				'haystack' => '',
				'needle'   => '',
				'expected' => true, // This differs from fp_starts_with().
			],
			'only needle passed'                   => [
				'haystack' => '',
				'needle'   => 'needle',
